...
describe('ad API:', function () {
  ...
  describe('GET /api/ads', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/ads').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        ads = res.body;
  ...
  describe('POST /api/ads', function () {
    beforeEach(function (done) {
      (0, _supertest2.default)(app).post('/api/ads').send({
        name: 'New ad',
  ...
  describe('GET /api/ads/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/ads/' + newad._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        ad = res.body;
  ...
  describe('PUT /api/ads/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).put('/api/ads/' + newad._id).send({
        name: 'Updated ad',
  ...
  describe('DELETE /api/ads/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2.default)(app).delete('/api/ads/' + newad._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when ad does not exist', function (done) {
      (0, _supertest2.default)(app).delete('/api/ads/' + newad._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=ad.integration.js.map
